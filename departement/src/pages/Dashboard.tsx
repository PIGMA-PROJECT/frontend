      ...
      <div>
        ...
        {trend && (
          <div className={`text-sm flex items-center mt-1 ${trend.up ? 'text-green-500' : 'text-red-500'}`}>
            <TrendingUp className={`mr-1 ${!trend.up ? 'transform rotate-180' : ''}`} />
    ...
    <div>
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        ...
        <div className="mt-4 md:mt-0 flex items-center text-sm text-gray-600">
          ...
          <span>Données mises à jour le 14 mai 2025</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <DashboardCard 
          ...
          color="bg-green-500"
          trend={{ value: "4 nouveaux", up: true }}
          delay={0.2}
        />
        <DashboardCard 
          title="Étudiants" 
          ...
          color="bg-purple-500"
          trend={{ value: "12 nouveaux", up: true }}
          delay={0.3}
        />
        <DashboardCard 
          title="Professeurs" 
              ...
              <div key={index} className="flex items-start pb-4 border-b border-gray-100 last:border-0">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    {index % 3 === 0 
                      ? 'Le mémoire "Intelligence Artificielle appliquée" a été soumis.' 
                      : index % 3 === 1 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          ...
          <div className="mb-4 grid grid-cols-7 gap-1 text-center">
            ...
            {[...Array(31)].map((_, i) => {
              const day = i + 1;
              const isToday = day === 14; // 14 mai 2025
